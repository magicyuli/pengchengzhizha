...
public class RandomValidationCodeUtil {
    ...
    public void getRandcode(HttpServletRequest request,
        ...
        session.removeAttribute(Conf.RANDOM_VALIDATION_CODE_SESSION_KEY);
        session.setAttribute(Conf.RANDOM_VALIDATION_CODE_SESSION_KEY, randomString);
    ...
    private String drowString(Graphics g,String randomString,int i) {
        ...
        String rand = String.valueOf(StringUtil.getRandomString(1));
        randomString +=rand;
