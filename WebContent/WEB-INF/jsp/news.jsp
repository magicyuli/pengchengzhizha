...
<body>
	...
	<div class="col-md-3">
		<div class="list-group">
			<a href="/manage/news/newsList/" target="content_frame" class="list-group-item">新闻列表</a>
			<a href="/manage/news/publish/" target="content_frame" class="list-group-item">新闻发布</a>
		</div>
	</div>
	<div class="col-md-9">
		<iframe src="" frameborder="0" width="100%" id="content_frame" name="content_frame" onload="contentFrameOnload();"></iframe>
	</div>
