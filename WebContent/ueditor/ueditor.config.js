...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars:[
            ['undo', 'redo', '|',
                'bold', 'italic', 'underline', 'superscript', 'subscript', 'formatmatch', 'pasteplain', '|', 'forecolor', 'backcolor', 'insertorderedlist', 'insertunorderedlist', 'selectall', 'cleardoc', '|',
                'lineheight', '|',
                'customstyle', 'paragraph', 'fontfamily', 'fontsize', '|',
                'indent', '|',
                'justifyleft', 'justifycenter', 'justifyright', 'justifyjustify', '|',
                'link', 'unlink', 'anchor', '|', 'imagenone', 'imageleft', 'imageright', 'imagecenter', '|',
                'insertimage', 'attachment', 'map', 'gmap', '|',
                'horizontal']
        ]
